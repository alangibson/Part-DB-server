...
add( "de", {
    ...
    'Param object by name': 'Parameterobjekt nach Name',
    ...
    '4-band resistor color code': '4-Band-Widerstandsfarbcode',
    '4-band resistor color code with tolerance': '4-Band-Widerstandsfarbcode mit Toleranz',
    '5-band resistor color code': '5-Band-Widerstandsfarbcode',
    '5-band resistor color code with tolerance': '5-Band-Widerstandsfarbcode mit Toleranz',
    '3-digit SMD resistor code': '3-stelliger SMD-Widerstandscode',
    '3-digit SMD resistor code with tolerance': '3-stelliger SMD-Widerstandscode mit Toleranz',
    '4-digit SMD resistor code': '4-stelliger SMD-Widerstandscode',
    '4-digit SMD resistor code with tolerance': '4-stelliger SMD-Widerstandscode mit Toleranz',
    'EIA-96 SMD resistor code': 'EIA-96-SMD-Widerstandscode',
    'EIA-96 SMD resistor code with tolerance validation': 'EIA-96-SMD-Widerstandscode mit Toleranzprüfung',
    'IEC three-character capacitor code': 'IEC-Dreistellencode für Kondensatoren',
    'IEC three-character capacitor code with tolerance': 'IEC-Dreistellencode für Kondensatoren mit Toleranz',
    'EIA/IEC two-character compact capacitor code': 'EIA/IEC-Zweistellencode für Kondensatoren',
