...
add( "en", {
    ...
    '4-band resistor color code with tolerance': '4-band resistor color code with tolerance',
    '5-band resistor color code': '5-band resistor color code',
    '5-band resistor color code with tolerance': '5-band resistor color code with tolerance',
    '3-digit SMD resistor code': '3-digit SMD resistor code',
    '3-digit SMD resistor code with tolerance': '3-digit SMD resistor code with tolerance',
    '4-digit SMD resistor code': '4-digit SMD resistor code',
    '4-digit SMD resistor code with tolerance': '4-digit SMD resistor code with tolerance',
    'EIA-96 SMD resistor code': 'EIA-96 SMD resistor code',
    'EIA-96 SMD resistor code with tolerance validation': 'EIA-96 SMD resistor code with tolerance validation',
    'IEC three-character capacitor code': 'IEC three-character capacitor code',
    'IEC three-character capacitor code with tolerance': 'IEC three-character capacitor code with tolerance',
    'EIA/IEC two-character compact capacitor code': 'EIA/IEC two-character compact capacitor code',
